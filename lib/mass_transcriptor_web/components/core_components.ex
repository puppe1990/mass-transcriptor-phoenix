defmodule MassTranscriptorWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      {@rest}
    >
      <p :if={@title} class="flash-toast__title">{@title}</p>
      <p class="flash-toast__message">{msg}</p>
    </div>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MassTranscriptorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MassTranscriptorWeb.Gettext, "errors", msg, opts)
    end
  end
