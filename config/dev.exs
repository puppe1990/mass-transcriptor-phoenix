...
config :mass_transcriptor, MassTranscriptorWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "/Hm6xcs9o9DHkDuMoay1RZSJr5lakAWUx5Lkl+wdirDf2h3w2btygoMxK/mgfIYU",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:mass_transcriptor, ~w(--sourcemap=inline --watch)]}
  ]
...
config :mass_transcriptor, MassTranscriptorWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/mass_transcriptor_web/router\.ex$"E,
      ~r"lib/mass_transcriptor_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :mass_transcriptor, dev_routes: true
